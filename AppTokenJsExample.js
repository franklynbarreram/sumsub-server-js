...
const SUMSUB_APP_TOKEN = 'sbx:ncQuhipMnnkJV3wwLyzkVR5h.1SUQC4ktZ2QmKtdKKa7GQ9jhXrCwvpCc'; // Example: tst:uY0CgwELmgUAEyl4hNWxLngb.0WSeQeiYny4WEqmAALEAiK2qTC96fBad - Please don't forget to change when switching to production
const SUMSUB_SECRET_KEY = 'QGDMDz0ipb17mz3IDhFSFfJrTUED8PpC'; // Example: Hej2ch71kG2kTd1iIUDZFNsO5C1lh5Gq - Please don't forget to change when switching to production
...
function createApplicant(externalUserId, levelName) {
  ...
  var body = {
      ...
      email: "franklynbarrera3110@gmail.com",
      fixedInfo: {
        firstName: "Franklyn",
        lastName: "Barrera"
      }
